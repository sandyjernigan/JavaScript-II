...
// The event director needs to send an email to everyone.
let emails = [];
runners.forEach(runners => emails.push(runners.email));
console.log(emails);

// Problem 2

// The event director needs a list of how many shirts to order in each size.
function getNumberofShirts(size) {
    return (runners.filter(runners => runners.shirt_size == size)).length;
}
let numXSmallShirts = getNumberofShirts("XS");
let numSmallShirts = getNumberofShirts("S");
let numMediumShirts = getNumberofShirts("M");
let numlargeShirts = getNumberofShirts("L");
let numXlargeShirts = getNumberofShirts("XL");
let num2XlargeShirts = getNumberofShirts("2XL");
let num3XlargeShirts = getNumberofShirts("3XL");
console.log(`XS: ${numXSmallShirts}, S: ${numSmallShirts}, M: ${numMediumShirts}, L: ${numlargeShirts}, XL: ${numXlargeShirts}, 2XL: ${num2XlargeShirts}, 3XL: ${num3XlargeShirts}`);

// Problem 3

//The event director wants a list of which companies the runners are coming from
let runnersCompany = runners.map(runners => runners.company_name);
